...
🚀 I enjoy shipping real products, working across the stack, and taking end-to-end ownership — from design through deployment.

🛠 Tech I like working with: Java, Python, SQL, distributed systems, cloud platforms (AWS, AZURE, GCP, OCI), and AI-powered apps.
...
**pooravdesai/pooravdesai** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
